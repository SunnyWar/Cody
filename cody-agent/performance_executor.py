...
def call_ai(prompt: str, config: dict, repo_root: Path) -> str:
    ...
    if model:
        ...
        print("🤖 Implementing optimization...")
...
"""
    ...
    try:
        ...
        error_path = logs_dir / f"performance_exec_ai_error_{timestamp}.txt"
    ...
    if not file_path or not new_content:
        ...
        debug_file = repo_root / "temp_performance_response.txt"
    ...
    todo_list.save()
    record_last_change(repo_root, "performance", item_id, [file_path])
